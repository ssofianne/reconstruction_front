...
const mockWorks: Work[] = [
  {pk: 1, imageurl: 'src/assets/default_image.png', title: 'Работа', price: 4000, description: 'Описание отсутствует'},
  {pk: 2, imageurl: 'src/assets/default_image.png', title: 'Работа', price: 4000, description: 'Описание отсутствует'},
  {pk: 3, imageurl: 'src/assets/default_image.png', title: 'Работа', price: 4000, description: 'Описание отсутствует'},
];
...
export const fetchWork = async (workId: number): Promise<Work> => {
    try {
